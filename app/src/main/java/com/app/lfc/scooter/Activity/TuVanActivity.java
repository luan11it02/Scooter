...
public class TuVanActivity extends AppCompatActivity {
    ...
    List<XeError> errorList = new ArrayList<>();
    ...
    public void getSpinner(String xe){
        ...
        database.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                adapter = new ArrayAdapter(TuVanActivity.this, android.R.layout.simple_spinner_item, listSpinner);
                    ...
                    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        databaseReference.addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                adapterError = new XeErrorAdapter(TuVanActivity.this, errorList);
